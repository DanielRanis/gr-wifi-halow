...
public:
	virtual ~base() {};
	virtual void equalize(gr_complex *in, int n, gr_complex *symbols, uint8_t *bits, boost::shared_ptr<gr::digital::constellation> mod, bool s1g_cap)= 0;
	virtual double get_snr() = 0;

	static const gr_complex POLARITY[127];
	static const gr_complex S1G_POLARITY[4];

protected:
	static const gr_complex LONG[64];
	static const gr_complex LONG_S1G[64];
};
